...
contract ErrorHandlingInvariants{
    ...
    2) Insert the person
    3) Get the person
    4) Delete the contract - done by error handling REQUIRE using contract creator
    ...
    6) Use Invariants with ASSERT
        check that msg.sender = Person ie people we just created
        cant use msg.sender == people
        you have to encode people and then hash
